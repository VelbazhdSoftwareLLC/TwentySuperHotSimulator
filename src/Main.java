...
/*==============================================================================
* 20 Super Hot Slot Simulation version 0.0.1                                   *
...
public class Main {
	...
	private static final int[][] PAYTABLE = {
			...
			new int[] { 100, 40, 20, 20, 20, 10, 10, 10, 0, 0, 0, 0, 0 },

			new int[] { 400, 400, 80, 40, 40, 20, 20, 20, 0, 0, 0, 0, 0 },

			new int[] { 10000, 1000, 400, 200, 200, 100, 100, 100, 0, 0, 0, 0, 0 },
	...
	private static final String[][] BASE_REELS = {
			...
			new String[] { "SEVEN", "SEVEN", "SEVEN", "ORANGE", "ORANGE", "ORANGE", "CHERRY", "CHERRY", "CHERRY",
					"PLUM", "PLUM", "PLUM", "WATERMELON", "WATERMELON", "WATERMELON", "LEMON", "LEMON", "LEMON", "PLUM",
					"PLUM", "PLUM", "LEMON", "LEMON", "LEMON", "WATERMELON", "WATERMELON", "WATERMELON", "LEMON",
					"LEMON", "LEMON", "GRAPE", "GRAPE", "GRAPE", "ORANGE", "ORANGE", "ORANGE", "STAR", "WATERMELON",
					"WATERMELON", "WATERMELON", "LEMON", "LEMON", "LEMON", "ORANGE", "ORANGE", "ORANGE", "PLUM", "PLUM",
					"PLUM", "CHERRY", "CHERRY", "CHERRY", "LEMON", "LEMON", "LEMON", "GRAPE", "GRAPE", "GRAPE", "STAR",
					"ORANGE", "ORANGE", "ORANGE", "GRAPE", "GRAPE", "GRAPE", "CHERRY", "CHERRY", "CHERRY", "LEMON",
					"LEMON", "LEMON", "GRAPE", "GRAPE", "GRAPE", "CHERRY", "CHERRY", "CHERRY", "PLUM", "PLUM", "PLUM",
					"CHERRY", "CHERRY", "CHERRY", "LEMON", "LEMON", "LEMON", "GRAPE", "GRAPE", "GRAPE", "ORANGE",
					"ORANGE", "ORANGE", "LEMON", "LEMON", "LEMON", "GRAPE", "GRAPE", "GRAPE", "ORANGE", "ORANGE",
					"ORANGE", "LEMON", "LEMON", "LEMON", },

			new String[] { "SEVEN", "SEVEN", "SEVEN", "LEMON", "LEMON", "LEMON", "ORANGE", "ORANGE", "ORANGE", "PLUM",
					"PLUM", "PLUM", "CHERRY", "CHERRY", "CHERRY", "WATERMELON", "WATERMELON", "WATERMELON", "PLUM",
					"PLUM", "PLUM", "ORANGE", "ORANGE", "ORANGE", "WATERMELON", "WATERMELON", "WATERMELON", "LEMON",
					"LEMON", "LEMON", "ORANGE", "ORANGE", "ORANGE", "CHERRY", "CHERRY", "CHERRY", "GRAPE", "GRAPE",
					"GRAPE", "ORANGE", "ORANGE", "ORANGE", "STAR", "CHERRY", "CHERRY", "CHERRY", "GRAPE", "GRAPE",
					"GRAPE", "WATERMELON", "WATERMELON", "WATERMELON", "LEMON", "LEMON", "LEMON", "ORANGE", "ORANGE",
					"ORANGE", "CHERRY", "CHERRY", "CHERRY", "GRAPE", "GRAPE", "GRAPE", "ORANGE", "ORANGE", "ORANGE",
					"STAR", "PLUM", "PLUM", "PLUM", "LEMON", "LEMON", "LEMON", "CHERRY", "CHERRY", "CHERRY", "GRAPE",
					"GRAPE", "GRAPE", "WATERMELON", "WATERMELON", "WATERMELON", "ORANGE", "ORANGE", "ORANGE", "LEMON",
					"LEMON", "LEMON", "WATERMELON", "WATERMELON", "WATERMELON", "PLUM", "PLUM", "PLUM", "ORANGE",
					"ORANGE", "ORANGE", "WATERMELON", "WATERMELON", "WATERMELON", },

			new String[] { "SEVEN", "SEVEN", "SEVEN", "WATERMELON", "WATERMELON", "WATERMELON", "CHERRY", "CHERRY",
					"CHERRY", "ORANGE", "ORANGE", "ORANGE", "PLUM", "PLUM", "PLUM", "CHERRY", "CHERRY", "CHERRY",
					"WATERMELON", "WATERMELON", "WATERMELON", "LEMON", "LEMON", "LEMON", "PLUM", "PLUM", "PLUM",
					"CHERRY", "CHERRY", "CHERRY", "WATERMELON", "WATERMELON", "WATERMELON", "LEMON", "LEMON", "LEMON",
					"GRAPE", "GRAPE", "GRAPE", "ORANGE", "ORANGE", "ORANGE", "STAR", "GRAPE", "GRAPE", "GRAPE", "PLUM",
					"PLUM", "PLUM", "LEMON", "LEMON", "LEMON", "CHERRY", "CHERRY", "CHERRY", "ORANGE", "ORANGE",
					"ORANGE", "GRAPE", "GRAPE", "GRAPE", "LEMON", "LEMON", "LEMON", "STAR", "PLUM", "PLUM", "PLUM",
					"CHERRY", "CHERRY", "CHERRY", "WATERMELON", "WATERMELON", "WATERMELON", "ORANGE", "ORANGE",
					"ORANGE", "CHERRY", "CHERRY", "CHERRY", "PLUM", "PLUM", "PLUM", "CHERRY", "CHERRY", "CHERRY",
					"WATERMELON", "WATERMELON", "WATERMELON", "LEMON", "LEMON", "LEMON", "PLUM", "PLUM", "PLUM", },

			new String[] { "SEVEN", "SEVEN", "SEVEN", "LEMON", "LEMON", "LEMON", "WATERMELON", "WATERMELON",
					"WATERMELON", "CHERRY", "CHERRY", "CHERRY", "GRAPE", "GRAPE", "GRAPE", "ORANGE", "ORANGE", "ORANGE",
					"LEMON", "LEMON", "LEMON", "CHERRY", "CHERRY", "CHERRY", "ORANGE", "ORANGE", "ORANGE", "PLUM",
					"PLUM", "PLUM", "ORANGE", "ORANGE", "ORANGE", "LEMON", "LEMON", "LEMON", "CHERRY", "CHERRY",
					"CHERRY", "GRAPE", "GRAPE", "GRAPE", "WATERMELON", "WATERMELON", "WATERMELON", "ORANGE", "ORANGE",
					"ORANGE", "LEMON", "LEMON", "LEMON", "STAR", "CHERRY", "CHERRY", "CHERRY", "ORANGE", "ORANGE",
					"ORANGE", "PLUM", "PLUM", "PLUM", "ORANGE", "ORANGE", "ORANGE", "LEMON", "LEMON", "LEMON", "CHERRY",
					"CHERRY", "CHERRY", "WATERMELON", "WATERMELON", "WATERMELON", "LEMON", "LEMON", "LEMON", "GRAPE",
					"GRAPE", "GRAPE", "ORANGE", "ORANGE", "ORANGE", "LEMON", "LEMON", "LEMON", "CHERRY", "CHERRY",
					"CHERRY", "ORANGE", "ORANGE", "ORANGE", "PLUM", "PLUM", "PLUM", "GRAPE", "GRAPE", "GRAPE", "PLUM",
					"PLUM", "PLUM", "ORANGE", "ORANGE", "ORANGE", "LEMON", "LEMON", "LEMON", "CHERRY", "CHERRY",
					"CHERRY", "WATERMELON", "WATERMELON", "WATERMELON", "PLUM", "PLUM", "PLUM", "ORANGE", "ORANGE",
					"ORANGE", "STAR", "LEMON", "LEMON", "LEMON", "CHERRY", "CHERRY", "CHERRY", "WATERMELON",
					"WATERMELON", "WATERMELON", "LEMON", "LEMON", "LEMON", "GRAPE", "GRAPE", "GRAPE", "ORANGE",
					"ORANGE", "ORANGE", "LEMON", "LEMON", "LEMON", "CHERRY", "CHERRY", "CHERRY", "WATERMELON",
					"WATERMELON", "WATERMELON", "PLUM", "PLUM", "PLUM", "ORANGE", "ORANGE", "ORANGE", },

			new String[] { "SEVEN", "SEVEN", "SEVEN", "ORANGE", "ORANGE", "ORANGE", "WATERMELON", "WATERMELON",
					"WATERMELON", "LEMON", "LEMON", "LEMON", "GRAPE", "GRAPE", "GRAPE", "CHERRY", "CHERRY", "CHERRY",
					"STAR", "ORANGE", "ORANGE", "ORANGE", "PLUM", "PLUM", "PLUM", "LEMON", "LEMON", "LEMON", "GRAPE",
					"GRAPE", "GRAPE", "ORANGE", "ORANGE", "ORANGE", "PLUM", "PLUM", "PLUM", "STAR", "CHERRY", "CHERRY",
					"CHERRY", "WATERMELON", "WATERMELON", "WATERMELON", "ORANGE", "ORANGE", "ORANGE", "GRAPE", "GRAPE",
					"GRAPE", "LEMON", "LEMON", "LEMON", "WATERMELON", "WATERMELON", "WATERMELON", "ORANGE", "ORANGE",
					"ORANGE", "PLUM", "PLUM", "PLUM", "ORANGE", "ORANGE", "ORANGE", "CHERRY", "CHERRY", "CHERRY",
					"PLUM", "PLUM", "PLUM", "CHERRY", "CHERRY", "CHERRY", "LEMON", "LEMON", "LEMON", "WATERMELON",
					"WATERMELON", "WATERMELON", "ORANGE", "ORANGE", "ORANGE", "LEMON", "LEMON", "LEMON", "CHERRY",
					"CHERRY", "CHERRY", "PLUM", "PLUM", "PLUM", "LEMON", "LEMON", "LEMON", },
	...
	private static void printHelp() {
		System.out.println("*******************************************************************************");
		System.out.println("* 20 Super Hot Slot Simulation version 0.0.1                                  *");
